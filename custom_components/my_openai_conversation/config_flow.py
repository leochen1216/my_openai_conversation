...
async def validate_input(hass: HomeAssistant, data: dict[str, Any]) -> None:
    ...
    if data.get(CONF_API_BASE):
        client_kwargs["base_url"] = data[CONF_API_BASE]
...
class OpenAISubentryFlowHandler(ConfigSubentryFlow):
    ...
    async def _get_location_data(self) -> dict[str, str]:
        ...
        if zone_home is not None:
            ...
            if self._get_entry().data.get(CONF_API_BASE):
                client_kwargs["base_url"] = self._get_entry().data[CONF_API_BASE]
